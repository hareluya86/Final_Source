...
<title>ComS 561 Project - Products</title>
        ...
        <div id="content" class="float_r">
        	...
        	<s:if test="categoryId != 0">
				<div class="breadcrumb">
					...
					<s:iterator value="breadcrumb" status="category">
						<s:if test="%{#category.last}">
							<a href='<s:url action="products"><s:param name="categoryId" value="id" /></s:url>'><s:property value="name" /></a>
						</s:if>
						<s:else>
							<a href='<s:url action="products"><s:param name="categoryId" value="id" /></s:url>'><s:property value="name" /></a> \
						</s:else>
					...
					<!--
					<a href="products.html">Top category</a> \
					<a href="products.html">Middle category</a> \
			...
			<s:if test="subcategories != null && subcategories.size() > 0">
				...
				<div class="subcategories_list">
					...
					<ul>
						...
						<s:iterator value="subcategories" status="category">
							<li>
			...
			<s:else>
				<h1><s:property  value="categoryName" /></h1>
			</s:else>
