...
public class Product implements Serializable {
    ...
    @JoinTable(name = "Product_ProductImage", joinColumns =
    @JoinColumn(name = "ProductId"), inverseJoinColumns =
    @JoinColumn(name = "ProductImageId"))
    private Collection<ProductImage> images;
    @OneToMany
    @Cascade(CascadeType.ALL)
    @JoinTable(name = "Product_ProductRating", joinColumns =
    @JoinColumn(name = "ProductId"), inverseJoinColumns =
    @JoinColumn(name = "ProductRatingId"))
    private Collection<ProductRating> ratings;
    @OneToMany
    @Cascade(CascadeType.ALL)
    @JoinTable(name = "Product_ProductDetail", joinColumns =
    @JoinColumn(name = "ProductId"), inverseJoinColumns =
