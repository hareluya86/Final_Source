...
public class Utilities1 {
    ...
    public static List<Category> getTopCategories() {
         ...
         * "Pants","","",null,null) ); categories.add( new Category(3,
         * "Shirts","","",null,null) ); categories.add( new Category(4,
         * "Socks","","",null,null) ); categories.add( new Category(5,
         * "Hats","","",null,null) ); categories.add( new Category(6,
         * "Coats","","",null,null) ); categories.add( new Category(7,
         * "Shorts","","",null,null) );
         *
         ...
         * nikesSubcategories.add( new Category(14,"Running
         * Shoes","","",null,null) ); nikesSubcategories.add( new
         * Category(15,"Cleats","","",null,null) );
         *
         *
         * ArrayList<Category> shoesSubcategories = new ArrayList<Category>();
         * shoesSubcategories.add( new
         * Category(8,"Nikes","","",nikesSubcategories,null) );
